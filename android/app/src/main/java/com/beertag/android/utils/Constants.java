...
public class Constants {
    ...
    public static final String UNSUCCESSFUL_CREATION = "Unsuccessful create new defaultbeerpicture!";
    ...
    public static final String USER_IMAGE_CHANGE_ERROR_MESSAGE = "User image update failed!";
    ...
    public static final String ERROR_LOADING_USER_IMAGE = "Error loading user picture";
